...
initFunc = function (self) {
    ...
    // video
    self.loadVideoView = function(param) {
        IWNativeCore.loadVideoView(param);
    }
    self.closeVideoView = function() {
        IWNativeCore.closeVideoView();
    }
...
//--------------------------------------------------------------------------------
    ...
    self.captureFace = function(args, callback) {
        ...
        self._addWatchName("captureFaceSuccessCallback")
        ...
        self._addWatchName("captureFaceFailedCallback")
    }
    ...
    */
     ...
     * @param {*} callback 
     */
    self.checkNetworkSpeed = function(callback){
...
//--------------------------------------------------------------------------------
    ...
    self.shareVideoFile = function(params, callback) {
        ...
        self.vm.$watch("shareVideoGenQRCode", function(res) { callback.success(res) }, { } )
        self._addWatchName("shareVideoGenQRCode")
        self.vm.$watch("shareVideoUploadFinish", function(res) { callback.finish(res) }, { } )
        self._addWatchName("shareVideoUploadFinish")
        self.vm.$watch("shareVideoError", function(res) { callback.failed(res) }, { } )
...
//--------------------------------------------------------------------------------
    ...
    self.core = function () {
        ...
        self.notifyShareVideoGenQRCode = function (data) {
            self.vm.shareVideoGenQRCode = data
        }
