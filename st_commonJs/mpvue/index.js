  ...
  function initMP (mpType, next) {
    ...
    if (mpType === 'app') {
      ...
      global.Page({
        ...
        getPhoneNumber:function getPhoneNumber(options){
          callHook$1(rootVueVM, 'getPhoneNumber', options);
        },

        bindRegionChange: function bindRegionChange (options) {
          callHook$1(rootVueVM, 'bindRegionChange', options);
        },

        formSubmit: function formSubmit (options) {
          callHook$1(rootVueVM, 'formSubmit', options);
        }
